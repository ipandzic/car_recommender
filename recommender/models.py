...
class Vehicle(models.Model):
    ...
    mpg_data = models.CharField(max_length=1, null=True, blank=True)
    ...
    guzzler = models.CharField(max_length=1, blank=True, null=True)
    transmission_descriptor = models.CharField(max_length=100, blank=True, null=True)
    t_charger = models.CharField(max_length=1, blank=True, null=True)
    s_charger = models.CharField(max_length=1, blank=True, null=True)
